// src/app/blog/tech/[columnSlug]/page.jsx
...
export default async function TechColumnPage({ params }) {
    const { columnSlug } = await params;
    ...
    return (
        <>
            <StructuredData data={structuredData} id="tech-column-structured-data" />
            <ColumnLayout
