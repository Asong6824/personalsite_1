// src/app/blog/finance/[columnSlug]/[postSlug]/page.jsx
...
export async function generateMetadata({ params }) {
    ...
    return generatePostMetadata(post, 'finance', columnSlug);
}
...
export default async function FinancePostPage({ params }) {
    ...
    return (
        <>
            <StructuredData data={structuredData} id="finance-post-structured-data" />
            <PostLayout
                post={post}
